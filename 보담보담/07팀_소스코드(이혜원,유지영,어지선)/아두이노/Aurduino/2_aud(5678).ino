...
String host = "172.16.120.60"; 

String pass;
int cot=0;

char temp[5]={0,};
char secretCode[5] = "5678"; // 비밀번호를 설정(여기선 1234)
...
void lckPassword(){  
  ...
  Serial.println("Send data..."); 
  cmd="GET /audPassword2.php?pass="+pass+"\r\n"; 
  mySerial.print("AT+CIPSEND="); 
  mySerial.println(cmd.length());
...
void cgPassword(){
  ...
  Serial.println("Send data..."); 
  cmd="GET /audCgPass.php?qwe=0606969\r\n"; 
  mySerial.print("AT+CIPSEND="); 
  mySerial.println(cmd.length());
...
void autoOpen(){
  ...
  Serial.println("Send data..."); 
  cmd="GET /audAutoOpen.php?qwe=0606969\r\n"; 
  mySerial.print("AT+CIPSEND="); 
  mySerial.println(cmd.length());
...
void userAlert(){
  ...
  Serial.println("Send data..."); 
  cmd="GET /audnotice.php?qwe=0606969&zxc=1\r\n"; 
  mySerial.print("AT+CIPSEND="); 
  mySerial.println(cmd.length());
...
void adimAlert(){
  ...
  Serial.println("Send data..."); 
  cmd="GET /audnotice.php?qwe=0606969&zxc=2\r\n"; 
  mySerial.print("AT+CIPSEND="); 
  mySerial.println(cmd.length());
...
void notreset(){
  ...
  Serial.println("Send data..."); 
  cmd="GET /audnotice.php?qwe=0606969&zxc=0\r\n"; 
  mySerial.print("AT+CIPSEND="); 
  mySerial.println(cmd.length());
